...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'model_data/l/best_epoch_weights.pth',      # "model_path"        : 'model_data/best_epoch_weights.pth',
    ...
    def get_map_txt(self, image_id, image, class_names, map_out_path):
        ...
        # 添加脉冲发放监视器
        fr_monitor = monitor.OutputMonitor(self.net, neuron.LIFNode, cal_firing_rate)
        ...
        with torch.no_grad():
            ...
            # ops, params = get_model_complexity_info(self.net, (3, 640, 640), image_data, as_strings=True,
